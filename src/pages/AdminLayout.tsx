...
const navigation = [
  ...
  { name: 'Agregar Usuario', href: '/add-user', icon: UsersIcon, current: false },
  { name: 'Lista de Usuarios', href: '/users-list', icon: FolderIcon, current: false }
]
    ...
    <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-gray-800">
            <div className="flex h-24 flex-shrink-0 items-center justify-center bg-gray-900 px-4">
              <img
        ...
        <div className="flex flex-col lg:pl-64">
          <div className="sticky top-0 z-10 flex h-16 sm:h-24 flex-shrink-0 bg-gray-700 shadow">
            <button
              type="button"
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex max-w-xs items-center rounded-full bg-white text-sm">
                      ...
                      <img
                        className="w-12 h-12 sm:h-16 sm:w-16 rounded-full"
                        ...
                        <Menu.Item key={item.name}>
                          {({ active }) => (
                            ...
                            onClick={onLogout}
                              ...
                              className={classNames(
                                active ? 'bg-gray-100' : '',
                                'text-center block px-4 py-2 text-sm text-gray-700 font-bold'
                              )}
                            >
                              {item.name}
                            </NavLink>
